...
def build_arg_parser():
    ...
    parser.add_argument("-file", dest="svm_file", required=False,
...
class Classify(object):
    ...
    def trainingForest(self, features, label):
        ...
        Classify.model = cv2.RTrees()
        Classify.model.train(features, cv2.CV_ROW_SAMPLE, label, params=self.params)
